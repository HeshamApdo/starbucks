...
export default function id({params}: any){
    return(
        <div className="w-[90%] mx-auto mt-[100px] xl:mt-[140px] font-serif">
            <div>
                {productsMain.map((prods) =>(
                    prods.id === params.id &&
                    <div>
                        {prods.compo.map((el) =>(
                            <div className="flex flex-col md:flex-row gap-4 items-center">
                                <div className="flex flex-col gap-3 justify-center items-center w-[300px] h-[300px] p-20 md:p-10 sm:w-[500px] sm:h-[500px]  relative group">
                                    <img src={el.image} className="lg:w-[400px] h-[500px] object-contain"/>
                                </div>
                                <div className="flex flex-col gap-4">
                                    <div className="text-3xl flex justify-center items-center text-center">
                                        {el.title}
                                    </div>
